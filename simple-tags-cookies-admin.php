...
function simtagcoo_validate($form){
	$options 			= get_option('simtagcoo_options');
	$updated 			= $options;
	$updated['fb_id'] 	= isset($form['fb_id']) ? $form['fb_id'] : '';
	$updated['fb_in'] 	= isset($form['fb_in']) ? $form['fb_in'] : '';
	$updated['fb_vc']	= isset($form['fb_vc']) ? $form['fb_vc'] : '';
	$updated['fb_ac']	= isset($form['fb_ac']) ? $form['fb_ac'] : '';
	$updated['fb_ic']	= isset($form['fb_ic']) ? $form['fb_ic'] : '';
	$updated['fb_pc']	= isset($form['fb_pc']) ? $form['fb_pc'] : '';
	$updated['tw_id'] 	= isset($form['tw_id']) ? $form['tw_id'] : '';
	$updated['tw_in'] 	= isset($form['tw_in']) ? $form['tw_in'] : '';
	$updated['tw_vc']	= isset($form['tw_vc']) ? $form['tw_vc'] : '';
	$updated['tw_ac']	= isset($form['tw_ac']) ? $form['tw_ac'] : '';
	$updated['tw_ic']	= isset($form['tw_ic']) ? $form['tw_ic'] : '';
	$updated['tw_pc']	= isset($form['tw_pc']) ? $form['tw_pc'] : '';
	$updated['in_id'] 	= isset($form['in_id']) ? $form['in_id'] : '';
	$updated['in_in'] 	= isset($form['in_in']) ? $form['in_in'] : '';
	$updated['pn_id'] 	= isset($form['pn_id']) ? $form['pn_id'] : '';
	$updated['pn_in'] 	= isset($form['pn_in']) ? $form['pn_in'] : '';
	$updated['in_vc'] 	= isset($form['in_vc']) ? $form['in_vc'] : '';
	$updated['in_ac'] 	= isset($form['in_ac']) ? $form['in_ac'] : '';
	$updated['in_ic'] 	= isset($form['in_ic']) ? $form['in_ic'] : '';
	$updated['in_pc'] 	= isset($form['in_pc']) ? $form['in_pc'] : '';
	$updated['pn_vc'] 	= isset($form['pn_vc']) ? $form['pn_vc'] : '';
	$updated['pn_ac'] 	= isset($form['pn_ac']) ? $form['pn_ac'] : '';
	$updated['pn_ic'] 	= isset($form['pn_ic']) ? $form['pn_ic'] : '';
	$updated['pn_pc'] 	= isset($form['pn_pc']) ? $form['pn_pc'] : '';
	$updated['tt_id'] 	= isset($form['tt_id']) ? $form['tt_id'] : '';
	$updated['tt_in'] 	= isset($form['tt_in']) ? $form['tt_in'] : '';
	$updated['tt_vc'] 	= isset($form['tt_vc']) ? $form['tt_vc'] : '';
	$updated['tt_ac'] 	= isset($form['tt_ac']) ? $form['tt_ac'] : '';
	$updated['tt_ic'] 	= isset($form['tt_ic']) ? $form['tt_ic'] : '';
	$updated['tt_pc'] 	= isset($form['tt_pc']) ? $form['tt_pc'] : '';
	$updated['ga_id'] 	= isset($form['ga_id']) ? $form['ga_id'] : '';
	$updated['ga_in'] 	= isset($form['ga_in']) ? $form['ga_in'] : '';
	$updated['ga_vi']	= isset($form['ga_vi']) ? $form['ga_vi'] : '';
	$updated['ga_ac']	= isset($form['ga_ac']) ? $form['ga_ac'] : '';
	$updated['ga_bc']	= isset($form['ga_bc']) ? $form['ga_bc'] : '';
	$updated['ga_cp']	= isset($form['ga_cp']) ? $form['ga_cp'] : '';
	$updated['ga_pc']	= isset($form['ga_pc']) ? $form['ga_pc'] : '';
	$updated['go_id']	= isset($form['go_id']) ? $form['go_id'] : '';
	$updated['go_in']	= isset($form['go_in']) ? $form['go_in'] : '';
	$updated['go_js']	= isset($form['go_js']) ? $form['go_js'] : '';
	$updated['wo_sk']	= isset($form['wo_sk']) ? $form['wo_sk'] : '';
	$updated['wo_tx']	= isset($form['wo_tx']) ? $form['wo_tx'] : '';
	$updated['ct_in']	= isset($form['ct_in']) ? $form['ct_in'] : '';
	$updated['ct_ck']	= isset($form['ct_ck']) ? $form['ct_ck'] : '';
	$updated['ct_pk']	= isset($form['ct_pk']) ? $form['ct_pk'] : '';
	$updated['ct_nk']	= isset($form['ct_nk']) ? $form['ct_nk'] : '';
	$updated['co_dc']	= isset($form['co_dc']) ? $form['co_dc'] : '';
	$updated['co_ur']	= isset($form['co_ur']) ? $form['co_ur'] : '';
	$updated['co_ma']	= isset($form['co_ma']) ? $form['co_ma'] : '';
	$updated['co_bg']	= isset($form['co_bg']) ? $form['co_bg'] : '';
	$updated['co_tx']	= isset($form['co_tx']) ? $form['co_tx'] : '';
	return $updated;
}
